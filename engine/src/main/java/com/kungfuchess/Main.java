...
import com.kungfuchess.io.ProtocolConfig;
...
public final class Main {
    ...
    public static void main(String[] args) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            if (parsed.isCommandsSectionPresent()) {
                ...
                while ((line = reader.readLine()) != null) {
                    try {
                        ...
                        System.err.println(ProtocolConfig.IO_ERROR_PREFIX + e.getMessage());
                    }
                }
            } else {
            ...
            System.out.println(ProtocolConfig.ERROR_OUTPUT_PREFIX + e.getCode().name());
            System.exit(1);
        } catch (IllegalArgumentException | IllegalStateException e) {
            System.err.println(ProtocolConfig.IO_ERROR_PREFIX + e.getMessage());
            System.exit(1);
